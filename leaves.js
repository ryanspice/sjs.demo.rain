...
var Leave;
for (Leave = leavesNumber-1; Leave>=0; Leave--)
{
	leavesList[Leave] = Object.create(leavesType.prototype).init();
}
...
var leavesDraw = function(app) {
	...
	for (var Leave = leavesNumber-1; Leave>=0; Leave--)
	{
		L  = leavesList[Leave];
		x = L.position.x;
